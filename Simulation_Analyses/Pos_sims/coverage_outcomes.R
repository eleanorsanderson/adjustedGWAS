...
library(parallel)
library(msm)
results_med1<-read.csv("/mnt/storage/scratch/bu19525/BristolPhD/MVMRproject/output/pos/outcome/results_med_pos_1.csv")
results_con1<-read.csv("/mnt/storage/scratch/bu19525/BristolPhD/MVMRproject/output/pos/outcome/results_con_pos_1.csv")
results_corr1<-read.csv("/mnt/storage/scratch/bu19525/BristolPhD/MVMRproject/output/pos/outcome/results_corr_pos_1.csv")
...
write.csv(results_effect, "results_effect_double_out.csv")



write.csv(results_coverage_con, "Coverage_results_con_doubleout.csv")
write.csv(results_coverage_corr, "Coverage_results_corr_doubleout.csv")
write.csv(results_coverage_med, "Coverage_results_med_doubleout.csv")
...
write.csv(results_coverage, "results_coverage_double_out.csv")
