...
library(parallel)
library(msm)
results_med1<-read.csv("/mnt/storage/scratch/bu19525/BristolPhD/MVMRproject/output/pos/results_med_pos_1.csv")
results_con1<-read.csv("/mnt/storage/scratch/bu19525/BristolPhD/MVMRproject/output/pos/results_con_pos_1.csv")
results_corr1<-read.csv("/mnt/storage/scratch/bu19525/BristolPhD/MVMRproject/output/pos/results_corr_pos_1.csv")
...
results_bias_corr<-data.frame("sbp_effect" = (mean(results_bias_corr$sbp_effect, na.rm = T)),
...
results_bias_med<-data.frame("sbp_effect" = (mean(results_bias_med$sbp_effect, na.rm = T)),
...
results_bias_con<-data.frame("sbp_effect" = (mean(results_bias_con$sbp_effect, na.rm = T)),
...
row.names(results_bias_med) <- "med_results"
row.names(results_bias_corr) <- "corr_results"
row.names(results_bias_con) <- "con_results"
results_effect<-rbind(results_bias_med,results_bias_corr)
results_effect<-rbind(results_effect,results_bias_con)
write.csv(results_effect, "results_effect_exp.csv")



write.csv(results_coverage_con, "Coverage_results_con.csv")
write.csv(results_coverage_corr, "Coverage_results_corr.csv")
write.csv(results_coverage_med, "Coverage_results_med.csv")
...
write.csv(results_coverage, "results_coverage.csv")
