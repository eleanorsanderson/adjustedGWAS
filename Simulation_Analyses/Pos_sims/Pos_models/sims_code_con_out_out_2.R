...
dat <- datagen("confounder",250,0.4,0.8) 
...
write.csv(results, file = "/mnt/storage/scratch/bu19525/BristolPhD/MVMRproject/output/pos/outcome/results_con_pos_onlyout_2.csv")
