...
dat <- datagen("mediator",250,0.4,0.8) 
...
write.csv(results, file = "/mnt/storage/scratch/bu19525/BristolPhD/MVMRproject/output/pos/outcome/results_med_pos_onlyout_5.csv")
